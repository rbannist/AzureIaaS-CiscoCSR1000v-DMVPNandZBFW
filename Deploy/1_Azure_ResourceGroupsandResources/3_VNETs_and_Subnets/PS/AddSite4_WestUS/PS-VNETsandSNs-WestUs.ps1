...
$Site4Stage1DMZSubnetName = "$Orgcode-$Site4code-$Appcode-$Stage1code-vn01-sn03"
...
New-AzureRmVirtualNetwork -Name $Site4Stage1VNETName -ResourceGroupName $Site4Stage1CRRG -Location $Site4 -AddressPrefix $Site4Stage1AddressPrefix -Subnet $Site4Stage1MgmtSubnet,$Site4Stage1OutsideSubnet,$Site4Stage1DMZSubnet,$Site4Stage1InsideSubnet -Tag @{ Org="$Org"; App="$App"; Stage="$Stage1" }
New-AzureRmVirtualNetwork -Name $Site4Stage2VNETName -ResourceGroupName $Site4Stage2CRRG -Location $Site4 -AddressPrefix $Site4Stage2AddressPrefix -Subnet $Site4Stage2MgmtSubnet,$Site4Stage2OutsideSubnet,$Site4Stage2DMZSubnet,$Site4Stage2InsideSubnet -Tag @{ Org="$Org"; App="$App"; Stage="$Stage2" } 
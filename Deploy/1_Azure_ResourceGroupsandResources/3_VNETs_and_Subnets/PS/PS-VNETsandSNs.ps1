...
New-AzureRmVirtualNetwork -Name $Site1Stage1VNETName -ResourceGroupName $Site1Stage1CRRG -Location $Site1 -AddressPrefix $Site1Stage1AddressPrefix -Subnet $Site1Stage1MgmtSubnet,$Site1Stage1OutsideSubnet,$Site1Stage1DMZSubnet,$Site1Stage1InsideSubnet -Tag @{ Org="$Org"; App="$App"; Stage="$Stage1" }
New-AzureRmVirtualNetwork -Name $Site1Stage2VNETName -ResourceGroupName $Site1Stage2CRRG -Location $Site1 -AddressPrefix $Site1Stage2AddressPrefix -Subnet $Site1Stage2MgmtSubnet,$Site1Stage2OutsideSubnet,$Site1Stage2DMZSubnet,$Site1Stage2InsideSubnet -Tag @{ Org="$Org"; App="$App"; Stage="$Stage2" }
New-AzureRmVirtualNetwork -Name $Site2Stage1VNETName -ResourceGroupName $Site2Stage1CRRG -Location $Site2 -AddressPrefix $Site2Stage1AddressPrefix -Subnet $Site2Stage1MgmtSubnet,$Site2Stage1OutsideSubnet,$Site2Stage1DMZSubnet,$Site2Stage1InsideSubnet -Tag @{ Org="$Org"; App="$App"; Stage="$Stage1" }
New-AzureRmVirtualNetwork -Name $Site2Stage2VNETName -ResourceGroupName $Site2Stage2CRRG -Location $Site2 -AddressPrefix $Site2Stage2AddressPrefix -Subnet $Site2Stage2MgmtSubnet,$Site2Stage2OutsideSubnet,$Site2Stage2DMZSubnet,$Site2Stage2InsideSubnet -Tag @{ Org="$Org"; App="$App"; Stage="$Stage2" }
New-AzureRmVirtualNetwork -Name $Site3Stage1VNETName -ResourceGroupName $Site3Stage1CRRG -Location $Site3 -AddressPrefix $Site3Stage1AddressPrefix -Subnet $Site3Stage1MgmtSubnet,$Site3Stage1OutsideSubnet,$Site3Stage1DMZSubnet,$Site3Stage1InsideSubnet -Tag @{ Org="$Org"; App="$App"; Stage="$Stage1" } 
New-AzureRmVirtualNetwork -Name $Site3Stage2VNETName -ResourceGroupName $Site3Stage2CRRG -Location $Site3 -AddressPrefix $Site3Stage2AddressPrefix -Subnet $Site3Stage2MgmtSubnet,$Site3Stage2OutsideSubnet,$Site3Stage2DMZSubnet,$Site3Stage2InsideSubnet -Tag @{ Org="$Org"; App="$App"; Stage="$Stage2" } 

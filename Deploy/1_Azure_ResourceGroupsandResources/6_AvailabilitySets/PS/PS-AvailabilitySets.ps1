...
$Site2code = "sea"
$Site3code = "eus"
$Site1Stage1CSRVMRG = "rb-$Site1code-$App-$Stage1code-csrvm-rg01"
$Site2Stage1CSRVMRG = "rb-$Site2code-$App-$Stage1code-csrvm-rg01"
$Site3Stage1CSRVMRG = "rb-$Site3code-$App-$Stage1code-csrvm-rg01"
$Site1Stage2CSRVMRG = "rb-$Site1code-$App-$Stage2code-csrvm-rg01"
$Site2Stage2CSRVMRG = "rb-$Site2code-$App-$Stage2code-csrvm-rg01"
$Site3Stage2CSRVMRG = "rb-$Site3code-$App-$Stage2code-csrvm-rg01"
$Site1Stage1CSRVMAS = "rb-$Site1code-$App-$Stage1code-csrvm-as01"
$Site2Stage1CSRVMAS = "rb-$Site2code-$App-$Stage1code-csrvm-as01"
$Site3Stage1CSRVMAS = "rb-$Site3code-$App-$Stage1code-csrvm-as01"
$Site1Stage2CSRVMAS = "rb-$Site1code-$App-$Stage2code-csrvm-as01"
$Site2Stage2CSRVMAS = "rb-$Site2code-$App-$Stage2code-csrvm-as01"
$Site3Stage2CSRVMAS = "rb-$Site3code-$App-$Stage2code-csrvm-as01"

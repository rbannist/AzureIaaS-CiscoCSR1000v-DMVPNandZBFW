...
New-AzureRmResourceGroup -Name $Orgcode-$Site1code-$Appcode-$Stage1code-csrvm-rg01 -Location $Site1 -Tag @{ Org="$Org"; App="$App"; Stage="$Stage1" }
New-AzureRmResourceGroup -Name $Orgcode-$Site2code-$Appcode-$Stage1code-csrvm-rg01 -Location $Site2 -Tag @{ Org="$Org"; App="$App"; Stage="$Stage1" }
New-AzureRmResourceGroup -Name $Orgcode-$Site3code-$Appcode-$Stage1code-csrvm-rg01 -Location $Site3 -Tag @{ Org="$Org"; App="$App"; Stage="$Stage1" }
New-AzureRmResourceGroup -Name $Orgcode-$Site1code-$Appcode-$Stage2code-csrvm-rg01 -Location $Site1 -Tag @{ Org="$Org"; App="$App"; Stage="$Stage2" }
New-AzureRmResourceGroup -Name $Orgcode-$Site2code-$Appcode-$Stage2code-csrvm-rg01 -Location $Site2 -Tag @{ Org="$Org"; App="$App"; Stage="$Stage2" }
New-AzureRmResourceGroup -Name $Orgcode-$Site3code-$Appcode-$Stage2code-csrvm-rg01 -Location $Site3 -Tag @{ Org="$Org"; App="$App"; Stage="$Stage2" }

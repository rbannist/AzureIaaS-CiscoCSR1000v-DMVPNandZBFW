...
New-AzureRmResourceGroup -Name rb-$Site1code-$App-$Stage1code-csrvm-rg01 -Location $Site1 -Tag @{ App="$App";  Stage="$Stage1" }
New-AzureRmResourceGroup -Name rb-$Site2code-$App-$Stage1code-csrvm-rg01 -Location $Site2 -Tag @{ App="$App";  Stage="$Stage1" }
New-AzureRmResourceGroup -Name rb-$Site3code-$App-$Stage1code-csrvm-rg01 -Location $Site3 -Tag @{ App="$App";  Stage="$Stage1" }
New-AzureRmResourceGroup -Name rb-$Site1code-$App-$Stage2code-csrvm-rg01 -Location $Site1 -Tag @{ App="$App";  Stage="$Stage2" }
New-AzureRmResourceGroup -Name rb-$Site2code-$App-$Stage2code-csrvm-rg01 -Location $Site2 -Tag @{ App="$App";  Stage="$Stage2" }
New-AzureRmResourceGroup -Name rb-$Site3code-$App-$Stage2code-csrvm-rg01 -Location $Site3 -Tag @{ App="$App";  Stage="$Stage2" }

...
New-AzureRmResourceGroup -Name rb-$Site1code-$Appcode-$Stage1code-csrvm-rg101 -Location $Site1 -Tag @{ App="$App";  Stage="$Stage1" }
New-AzureRmResourceGroup -Name rb-$Site1code-$Appcode-$Stage1code-csrvm-rg102 -Location $Site1 -Tag @{ App="$App";  Stage="$Stage1" }
New-AzureRmResourceGroup -Name rb-$Site2code-$Appcode-$Stage1code-csrvm-rg101 -Location $Site2 -Tag @{ App="$App";  Stage="$Stage1" }
New-AzureRmResourceGroup -Name rb-$Site2code-$Appcode-$Stage1code-csrvm-rg102 -Location $Site2 -Tag @{ App="$App";  Stage="$Stage1" }
New-AzureRmResourceGroup -Name rb-$Site3code-$Appcode-$Stage1code-csrvm-rg101 -Location $Site3 -Tag @{ App="$App";  Stage="$Stage1" }
New-AzureRmResourceGroup -Name rb-$Site3code-$Appcode-$Stage1code-csrvm-rg102 -Location $Site3 -Tag @{ App="$App";  Stage="$Stage1" }
New-AzureRmResourceGroup -Name rb-$Site1code-$Appcode-$Stage2code-csrvm-rg101 -Location $Site1 -Tag @{ App="$App";  Stage="$Stage2" }
New-AzureRmResourceGroup -Name rb-$Site1code-$Appcode-$Stage2code-csrvm-rg102 -Location $Site1 -Tag @{ App="$App";  Stage="$Stage2" }
New-AzureRmResourceGroup -Name rb-$Site2code-$Appcode-$Stage2code-csrvm-rg101 -Location $Site2 -Tag @{ App="$App";  Stage="$Stage2" }
New-AzureRmResourceGroup -Name rb-$Site2code-$Appcode-$Stage2code-csrvm-rg102 -Location $Site2 -Tag @{ App="$App";  Stage="$Stage2" }
New-AzureRmResourceGroup -Name rb-$Site3code-$Appcode-$Stage2code-csrvm-rg101 -Location $Site3 -Tag @{ App="$App";  Stage="$Stage2" }
New-AzureRmResourceGroup -Name rb-$Site3code-$Appcode-$Stage2code-csrvm-rg102 -Location $Site3 -Tag @{ App="$App";  Stage="$Stage2" } 